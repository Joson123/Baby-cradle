...
* @{
*/
#define PRODUCT_KEY "4b4caff3026846e380f89c5a2c40b73c"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "68ccdceaf7a847c4b42df106c1d2d823"
...
* @{
*/
#define temp_check_BYTEOFFSET                    0
#define temp_check_BITOFFSET                     0
#define temp_check_LEN                           1
#define swing_state_BYTEOFFSET                    0
#define swing_state_BITOFFSET                     1
#define swing_state_LEN                           1
#define Warm_milk_BYTEOFFSET                    0
#define Warm_milk_BITOFFSET                     2
#define Warm_milk_LEN                           1
#define humidification_BYTEOFFSET                    0
#define humidification_BITOFFSET                     3
#define humidification_LEN                           1
#define weight_on_of_BYTEOFFSET                    0
#define weight_on_of_BITOFFSET                     4
#define weight_on_of_LEN                           1
#define purifier_BYTEOFFSET                    0
#define purifier_BITOFFSET                     5
#define purifier_LEN                           1
#define wake_up_testing_switch_BYTEOFFSET                    0
#define wake_up_testing_switch_BITOFFSET                     6
#define wake_up_testing_switch_LEN                           1
#define cover_the_quilt_switch_BYTEOFFSET                    0
#define cover_the_quilt_switch_BITOFFSET                     7
#define cover_the_quilt_switch_LEN                           1
#define play_the_music_BYTEOFFSET                    1
#define play_the_music_BITOFFSET                     8
#define play_the_music_LEN                           3
#define rain_water_BYTEOFFSET                    2
#define rain_water_BITOFFSET                     0
#define rain_water_LEN                           2
#define cover_the_quilt_BYTEOFFSET                    2
#define cover_the_quilt_BITOFFSET                     2
#define cover_the_quilt_LEN                           2
#define on_the_bed_BYTEOFFSET                    2
#define on_the_bed_BITOFFSET                     4
#define on_the_bed_LEN                           2
#define wake_up_testing_BYTEOFFSET                    2
#define wake_up_testing_BITOFFSET                     6
#define wake_up_testing_LEN                           2

#define dht11_tempe_RATIO                         0.1
#define dht11_tempe_ADDITION                      0
#define dht11_tempe_MIN                           0
#define dht11_tempe_MAX                           1000
#define dht11_humidity_RATIO                         0.1
#define dht11_humidity_ADDITION                      0
#define dht11_humidity_MIN                           0
#define dht11_humidity_MAX                           1000
#define mq_7_RATIO                         0.1
#define mq_7_ADDITION                      0
#define mq_7_MIN                           0
#define mq_7_MAX                           1000
#define mlx90614_RATIO                         0.1
#define mlx90614_ADDITION                      0
#define mlx90614_MIN                           0
#define mlx90614_MAX                           1000
#define longitude_RATIO                         0.0001
#define longitude_ADDITION                      0
#define longitude_MIN                           0
#define longitude_MAX                           100000000
#define latitude_RATIO                         0.0001
#define latitude_ADDITION                      0
#define latitude_MIN                           0
#define latitude_MAX                           1000000000
/**@} */
...
typedef enum
{
    play_the_music_VALUE0 = 0,//关
    play_the_music_VALUE1 = 1,//世上只有妈妈好
    play_the_music_VALUE2 = 2,//数鸭子
    play_the_music_VALUE3 = 3,//抓泥鳅
    play_the_music_VALUE4 = 4,//上学歌
    play_the_music_VALUE5 = 5,//小兔子乖乖
    play_the_music_VALUE6 = 6,//摇篮曲
    play_the_music_VALUE_MAX,
} play_the_music_ENUM_T;
typedef enum
{
    rain_water_VALUE0 = 0,//--
    rain_water_VALUE1 = 1,//否
    rain_water_VALUE2 = 2,//是
    rain_water_VALUE_MAX,
} rain_water_ENUM_T;
typedef enum
{
    cover_the_quilt_VALUE0 = 0,//--
    cover_the_quilt_VALUE1 = 1,//否
    cover_the_quilt_VALUE2 = 2,//是
    cover_the_quilt_VALUE_MAX,
} cover_the_quilt_ENUM_T;
typedef enum
{
    on_the_bed_VALUE0 = 0,//--
    on_the_bed_VALUE1 = 1,//是
    on_the_bed_VALUE2 = 2,//否
    on_the_bed_VALUE_MAX,
} on_the_bed_ENUM_T;
typedef enum
{
    wake_up_testing_VALUE0 = 0,//--
    wake_up_testing_VALUE1 = 1,//否
    wake_up_testing_VALUE2 = 2,//是
    wake_up_testing_VALUE_MAX,
} wake_up_testing_ENUM_T;
...
typedef enum
{
  ...
  EVENT_swing_state,
  EVENT_Warm_milk,
  EVENT_humidification,
  EVENT_weight_on_of,
  EVENT_purifier,
  EVENT_wake_up_testing_switch,
  EVENT_cover_the_quilt_switch,
  EVENT_play_the_music,
...
typedef struct {
  bool valuetemp_check;
  bool valueswing_state;
  bool valueWarm_milk;
  bool valuehumidification;
  bool valueweight_on_of;
  bool valuepurifier;
  bool valuewake_up_testing_switch;
  bool valuecover_the_quilt_switch;
  uint32_t valueplay_the_music;
  uint32_t valuerain_water;
  uint32_t valuecover_the_quilt;
  uint32_t valueon_the_bed;
  uint32_t valuewake_up_testing;
  float valuedht11_tempe;
  float valuedht11_humidity;
  float valuemq_7;
  float valuemlx90614;
...
typedef struct {
  uint8_t flagtemp_check:1;
  uint8_t flagswing_state:1;
  uint8_t flagWarm_milk:1;
  uint8_t flaghumidification:1;
  uint8_t flagweight_on_of:1;
  uint8_t flagpurifier:1;
  uint8_t flagwake_up_testing_switch:1;
  uint8_t flagcover_the_quilt_switch:1;
  uint8_t flagplay_the_music:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valuedht11_tempe;
  uint16_t valuedht11_humidity;
  uint16_t valuemq_7;
  uint16_t valuemlx90614;
  uint32_t valuelongitude;
